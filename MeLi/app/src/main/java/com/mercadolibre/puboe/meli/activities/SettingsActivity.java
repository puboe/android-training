    ...
    private Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                if(preference.getKey().equals(SYNC_FREQ)) {
                    // TODO UPDATE ALARM
                    Log.i("onPreferenceChange", "Update alarm with value: " + listPreference.getEntryValues()[index] + " min.");
                    AlarmSetter.setAlarm(SettingsActivity.this, Integer.parseInt((String)listPreference.getEntryValues()[index]));
                }
